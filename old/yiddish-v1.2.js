...
// modifiers
node.nodeValue = node.nodeValue.split('yy').join('ey');
node.nodeValue = node.nodeValue.split('uu').join('v');
node.nodeValue = node.nodeValue.split('uy').join('oy');
node.nodeValue = node.nodeValue.split('א').join('O');
node.nodeValue = node.nodeValue.split('Oy').join('i');
node.nodeValue = node.nodeValue.split('O').join('');
node.nodeValue = node.nodeValue.split('uS').join('es');
node.nodeValue = node.nodeValue.split('S').join('s');
node.nodeValue = node.nodeValue.split('zsh').join('zh');
node.nodeValue = node.nodeValue.split('by').join('bi');
node.nodeValue = node.nodeValue.split('vy').join('vi');
node.nodeValue = node.nodeValue.split('dy').join('di');
node.nodeValue = node.nodeValue.split('ty').join('ti');
node.nodeValue = node.nodeValue.split('hy').join('hi');
node.nodeValue = node.nodeValue.split('sy').join('si');
node.nodeValue = node.nodeValue.split('ry').join('ri');
node.nodeValue = node.nodeValue.split('ky').join('ki');
node.nodeValue = node.nodeValue.split('fy').join('fi');
node.nodeValue = node.nodeValue.split('py').join('pi');
node.nodeValue = node.nodeValue.split('my').join('mi');
node.nodeValue = node.nodeValue.split('ny').join('ni');
node.nodeValue = node.nodeValue.split('ly').join('li');
node.nodeValue = node.nodeValue.split('zy').join('zi');
...
// Text node
	// combinations
transl2str = transl2str.split('אַ').join('a');
transl2str = transl2str.split('אָ').join('o');
transl2str = transl2str.split('בּ').join('b');
transl2str = transl2str.split('בֿ').join('v');
transl2str = transl2str.split('כּ').join('k');
transl2str = transl2str.split('פּ').join('p');
transl2str = transl2str.split('פֿ').join('f');
transl2str = transl2str.split('שׂ').join('s');
transl2str = transl2str.split('תּ').join('t');
...
// modifiers
transl2str = transl2str.split('yy').join('ey');
transl2str = transl2str.split('uu').join('v');
transl2str = transl2str.split('uy').join('oy');
transl2str = transl2str.split('א').join('O');
transl2str = transl2str.split('Oy').join('i');
transl2str = transl2str.split('O').join('');
transl2str = transl2str.split('uS').join('es');
transl2str = transl2str.split('S').join('s');
transl2str = transl2str.split('zsh').join('zh');
transl2str = transl2str.split('by').join('bi');
transl2str = transl2str.split('vy').join('vi');
transl2str = transl2str.split('dy').join('di');
transl2str = transl2str.split('ty').join('ti');
transl2str = transl2str.split('hy').join('hi');
transl2str = transl2str.split('sy').join('si');
transl2str = transl2str.split('ry').join('ri');
transl2str = transl2str.split('ky').join('ki');
transl2str = transl2str.split('fy').join('fi');
transl2str = transl2str.split('py').join('pi');
transl2str = transl2str.split('my').join('mi');
transl2str = transl2str.split('ny').join('ni');
transl2str = transl2str.split('ly').join('li');
transl2str = transl2str.split('zy').join('zi');
